...
class Different(BasePage):
    ...
    ***'''
    ...
    碰撞求异模型
    *******'''
    different_model1 = 'xpath=>/html/body/div/div[2]/div[1]/div[3]/div/div/div[2]/div[2]/div[2]/ul[1]/li[31]'
    different_model2 = 'x=>/html/body/div/div[2]/div[1]/div[3]/div/div/div[2]/div[2]/div[2]/ul[1]/li[30]'
    different_model3 = 'x=>/html/body/div/div[2]/div[1]/div[3]/div/div/div[2]/div[2]/div[2]/ul[1]/li[29]'
    different_model4 = 'x=>/html/body/div/div[2]/div[1]/div[3]/div/div/div[2]/div[2]/div[2]/ul[1]/li[28]'

    def double_model1(self):
        time.sleep(1)
        self.click_twice(self.different_model1)
        Logger().info('进入碰撞求异模型1(单数据源)')

    def double_model2(self):
        time.sleep(1)
        self.click_twice(self.different_model2)
        Logger().info('进入碰撞求异模型2（双数据源）')

    def double_model3(self):
        time.sleep(1)
        self.click_twice(self.different_model3)
        Logger().info('进入碰撞求异模型3（多数据源）')

    def double_model4(self):
        time.sleep(1)
        self.click_twice(self.different_model4)
        Logger().info('进入碰撞求异模型4（连接碰撞求异组件）')

    def double_model5(self):
        time.sleep(1)
        self.click_twice(self.different_model5)
        Logger().info('进入碰撞求异模型5（连接其它组件）')

    """*********
    连接两个数据源
    *********"""
    jishuanzujuan1 = 'x=>//*[@id="ioper_03_1"]'
    preview1 = 'x=>//*[@id="menu3_1"]'  #预览
    preview1now = 'x=>//*[@id="ioper_15_1_c"]/button'
    delete1 = 'x=>//*[@id="menu3_undefined"]'
    peizhi1 = 'x=>//*[@id="menu0_undefined"]'
    peizhi1_1 = 'x=>//*[@id="ioper_03_1_a"]/div/div[1]/div/div[1]/input'
    peizhi1_2 = 'x=>//*[@id="ioper_03_1_a"]/div/div[2]/div/div/input'
    shuchu1 = 'x=>//*[@id="menu1_undefined"]'
    big1 = 'x=>//*[@id="ioper_03_1_b"]/div/div[1]/div[3]/button'
    small1 = 'x=>//*[@id="ioper_03_1_b"]/div/div[1]/div[3]/button'
    ziduan1 = 'x=>//*[@id="ioper_03_1_b"]/div/div[1]/div[2]/label/span[2]'
    ziduan_1 = 'x=>//*[@id="ioper_03_1_b"]/div/div[3]/div/label/span[2]'
    shuchu_1 = 'x=>//*[@id="ioper_03_1_b"]/div/div[2]/button[1]/i'
    chehui_1 = 'x=>//*[@id="ioper_03_1_b"]/div/div[2]/button[2]/i'
    search1 = 'x=>//*[@id="ioper_03_1_b"]/div/div[1]/div[1]/input'
