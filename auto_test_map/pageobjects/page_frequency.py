...
class Frenquency(BasePage):
    ...
    ***'''
    ...
    频率分析模型
    *******'''
    filter_model1 = 'x=>//*[@id="pane-model"]/div[2]/ul[1]/li[16]'
    filter_model2 = 'x=>//*[@id="pane-model"]/div[2]/ul[1]/li[15]'
    filter_model3 = 'x=>//*[@id="pane-model"]/div[2]/ul[1]/li[]'

    def double_model1(self):
        time.sleep(1)
        self.click_twice(self.filter_model1)
        Logger().info('进入频率分析模型1(单数据源)')

    def double_model2(self):
        time.sleep(1)
        self.click_twice(self.filter_model2)
        Logger().info('进入频率分析模型2（双组件）')

    def double_model3(self):
        time.sleep(1)
        self.click_twice(self.filter_model3)
        Logger().info('进入频率分析模型3（多数据源）')

    def double_model4(self):
        time.sleep(1)
        self.click_twice(self.filter_model4)
        Logger().info('进入频率分析模型4（连接频率分析组件）')

    def double_model5(self):
        time.sleep(1)
        self.click_twice(self.filter_model5)
        Logger().info('进入频率分析模型5（连接其它组件）')

    """*********
    连接两个数据源
    *********"""
    jishuanzujuan1 = 'x=>//*[@id="ioper_07_1"]'
    ...
    big1 = 'x=>//*[@id="ioper_07_1_b"]/div/div[1]/div[4]/button'
    small1 = 'x=>//*[@id="ioper_07_1_b"]/div/div[1]/div[4]/button'
    ziduan1 = 'x=>//*[@id="ioper_07_1_b"]/div/div[1]/div[3]/label'
    ziduan_1 = 'x=>//*[@id="ioper_07_1_b"]/div/div[3]/div/label/span[2]'
    shuchu_1 = 'x=>//*[@id="ioper_07_1_b"]/div/div[2]/button[1]/i'
    chehui_1 = 'x=>//*[@id="ioper_07_1_b"]/div/div[2]/button[2]/i'
    search1 = 'x=>//*[@id="ioper_07_1_b"]/div/div[1]/div[1]/input'
    choose_lla1 = 'x=>//*[@id="ioper_07_1_b"]/div/div[3]/label/span[1]/span'
    ...
    jishuanzujuan3 = 'x=>//*[@id="ioper_07_3"]'
    ...
    def click_peizhi1_23(self):
        self.select3(self.peizhi1_2)
        Logger().info('选择关系大于')
    ...
    # peizhi1_3 = 'x=>//*[@id="ioper_07_1_a"]/div/div[2]/div[4]/div/input'
    # peizhi1_2 = 'x=>//*[@id="ioper_07_1_a"]/div/div[2]/div[3]/div/div/input'
    # peizhi1_1 = 'x=>//*[@id="ioper_07_1_a"]/div/div[2]/div[2]/div/div/input'
    ...
    clean1 = 'x=>//*[@id="ioper_07_1_a"]/div/div[2]/div[5]/button[2]'
    zheng = 'x=>//*[@id="ioper_07_1_a"]/div/div[2]/div[5]/button[1]'
    ...
    peizhi1_1 = 'x=>//*[@id="ioper_07_1_a"]/div/div[1]/div/div[1]/input'
    peizhi1_2 = 'x=>//*[@id="ioper_07_1_a"]/div/div[2]/div/div[1]/input'
    peizhi1_3 = 'x=>//*[@id="ioper_07_1_a"]/div/div[3]/div/input'
    peizhi1_4 = 'x=>//*[@id="ioper_07_1_a"]/div[2]/div[2]/div[3]/div/div/input'
    peizhi1_5 = 'x=>//*[@id="ioper_07_1_a"]/div[2]/div[2]/div[4]/div/div[1]/input'
    peizhi1_6 = 'x=>//*[@id="ioper_07_1_a"]/div[2]/div[2]/div[5]/div/input'
    peizhi1_7 = 'x=>//*[@id="ioper_07_1_a"]/div[2]/div[2]/div[6]/div/div[1]/input'
    ...
    zhiduan1_1 = 'x=>//*[@id="ioper_07_1_b"]/div/div[3]/div[2]/label[1]'
