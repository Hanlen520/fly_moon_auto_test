...
class Combine(BasePage):
    ...
    ***'''
    ...
    合并数据模型
    *******'''
    different_model1 = 'xpath=>/html/body/div/div[2]/div[1]/div[3]/div/div/div[2]/div[2]/div[2]/ul[1]/li[27]'
    different_model2 = 'x=>/html/body/div/div[2]/div[1]/div[3]/div/div/div[2]/div[2]/div[2]/ul[1]/li[26]'
    different_model3 = 'x=>/html/body/div/div[2]/div[1]/div[3]/div/div/div[2]/div[2]/div[2]/ul[1]/li[25]'
    different_model4 = 'x=>/html/body/div/div[2]/div[1]/div[3]/div/div/div[2]/div[2]/div[2]/ul[1]/li[24]'
    different_model5 = 'x=>/html/body/div/div[2]/div[1]/div[3]/div/div/div[2]/div[2]/div[2]/ul[1]/li[23]'

    def double_model1(self):
        time.sleep(1)
        self.click_twice(self.different_model1)
        Logger().info('进入合并数据模型1(单数据源)')

    def double_model2(self):
        time.sleep(1)
        self.click_twice(self.different_model2)
        Logger().info('进入合并数据模型2（双数据源）')

    def double_model3(self):
        time.sleep(1)
        self.click_twice(self.different_model3)
        Logger().info('进入合并数据模型3（多数据源）')

    def double_model4(self):
        time.sleep(1)
        self.click_twice(self.different_model4)
        Logger().info('进入合并数据模型4（连接合并数据组件）')

    def double_model5(self):
        time.sleep(1)
        self.click_twice(self.different_model5)
        Logger().info('进入合并数据模型5（连接其它组件）')

    """*********
    连接两个数据源
    *********"""
    jishuanzujuan1 = 'x=>//*[@id="ioper_04_1"]'
    ...
    peizhi1_1 = 'x=>//*[@id="ioper_04_1_a"]/div/div[1]/div/div[1]/input'
    peizhi1_2 = 'x=>//*[@id="ioper_04_1_a"]/div/div[2]/div/div/input'
    shuchu1 = 'x=>//*[@id="menu1_undefined"]'
    big1 = 'x=>//*[@id="ioper_04_1_b"]/div/div[1]/div[3]/button'
    small1 = 'x=>//*[@id="ioper_04_1_b"]/div/div[1]/div[3]/button'
    ziduan1 = 'x=>//*[@id="ioper_04_1_a"]/div/div[1]/div[3]/label[1]'
    ziduan_1 = 'x=>//*[@id="ioper_04_1_a"]/div/div[3]/div[2]/label[1]'
    shuchu_1 = 'x=>//*[@id="ioper_04_1_a"]/div/div[2]/button[1]/i'
    chehui_1 = 'x=>//*[@id="ioper_04_1_a"]/div/div[2]/button[2]/i'
    search1 = 'x=>//*[@id="ioper_04_1_a"]/div/div[1]/div[1]/input'
    ...
    choose_all1 = 'x=>//*[@id="ioper_04_1_a"]/div/div[1]/label/span[1]/span'
    choose_lla1 = 'x=>//*[@id="ioper_04_1_a"]/div/div[3]/label/span[1]/span'
    ...
    def click_choose_all1(self):
        self.click(self.choose_all1)
    ...
    二级连接
    '''
    jishuanzujuan5 = 'x=>//*[@id="ioper_04_5"]'
    peizhi5 = 'x=>//*[@id="menu0_5"]'
    peizhi5_1 = 'x=>//*[@id="ioper_04_5_a"]/div/div[1]/div/div[1]/input'
    peizhi5_12 = 'x=>/html/body/div[2]/div[1]/div[1]/ul/li[2]'
    peizhi1_22 = 'x=>/html/body/div[4]/div[1]/div[1]/ul/li[2]'
    ziduan5_1 = 'x=>//*[@id="ioper_04_5_a"]/div/div[1]/div[3]/label[1]'
    chehui_5 = 'x=>//*[@id="ioper_04_5_a"]/div/div[2]/button[2]/i'
    ...
    def click_ziduan5_1(self):
        self.click(self.ziduan5_1)
        Logger().info('勾选输出字段')

    def click_chehui_5(self):
        self.click(self.chehui_5)
        Logger().info('点击下拉框1')
