# -*- coding: utf-8 -*-
# @Time    : 2018/7/5 0005 9:05
# @Author  : 郝一阳
# @FileName: page_condition.py
# @Software: PyCharm
# coding=utf-8
...
class Condition(BasePage):
    ...
    ***'''
    ...
    条件碰撞模型
    *******'''
    filter_model1 = 'x=>//*[@id="pane-model"]/div[2]/ul[1]/li[19]'
    filter_model2 = 'x=>//*[@id="pane-model"]/div[2]/ul[1]/li[18]'
    filter_model3 = 'x=>//*[@id="pane-model"]/div[2]/ul[1]/li[17]'

    def double_model1(self):
        time.sleep(1)
        self.click_twice(self.filter_model1)
        Logger().info('进入条件碰撞模型1(单数据源)')

    def double_model2(self):
        time.sleep(1)
        self.click_twice(self.filter_model2)
        Logger().info('进入条件碰撞模型2（双组件）')

    def double_model3(self):
        time.sleep(1)
        self.click_twice(self.filter_model3)
        Logger().info('进入条件碰撞模型3（多数据源）')

    def double_model4(self):
        time.sleep(1)
        self.click_twice(self.filter_model4)
        Logger().info('进入条件碰撞模型4（连接条件碰撞组件）')

    def double_model5(self):
        time.sleep(1)
        self.click_twice(self.filter_model5)
        Logger().info('进入条件碰撞模型5（连接其它组件）')

    """*********
    连接两个数据源
    *********"""
    jishuanzujuan1 = 'x=>//*[@id="ioper_08_1"]'
    ...
    big1 = 'x=>//*[@id="ioper_08_1_b"]/div/div[1]/div[4]/button'
    small1 = 'x=>//*[@id="ioper_08_1_b"]/div/div[1]/div[4]/button'
    ziduan1 = 'x=>//*[@id="ioper_08_1_b"]/div/div[1]/div[3]/label[1]'
    ziduan_1 = 'x=>//*[@id="ioper_08_1_b"]/div/div[3]/div/label/span[2]'
    shuchu_1 = 'x=>//*[@id="ioper_08_1_b"]/div/div[2]/button[1]/i'
    chehui_1 = 'x=>//*[@id="ioper_08_1_b"]/div/div[2]/button[2]/i'
    search1 = 'x=>//*[@id="ioper_08_1_b"]/div/div[1]/div[1]/input'
    choose_lla1 = 'x=>//*[@id="ioper_08_1_b"]/div/div[3]/label/span[1]/span'
    ...
    choose_lla2 = 'x=>//*[@id="cnode_1028_2_b"]/div/div[3]/label/span[1]/span'
    ...
    jishuanzujuan3 = 'x=>//*[@id="ioper_08_3"]'
    ...
    # peizhi1_3 = 'x=>//*[@id="ioper_08_1_a"]/div/div[2]/div[4]/div/input'
    # peizhi1_2 = 'x=>//*[@id="ioper_08_1_a"]/div/div[2]/div[3]/div/div/input'
    # peizhi1_1 = 'x=>//*[@id="ioper_08_1_a"]/div/div[2]/div[2]/div/div/input'
    ...
    clean1 = 'x=>//*[@id="ioper_08_1_a"]/div/div[2]/div[5]/button[2]'
    zheng = 'x=>//*[@id="ioper_08_1_a"]/div/div[2]/div[5]/button[1]'
    ...
    peizhi1_1 = 'x=>//*[@id="ioper_08_1_a"]/div[1]/div[2]/div[2]/div/div/input'
    peizhi1_2 = 'x=>//*[@id="ioper_08_1_a"]/div[1]/div[2]/div[4]/div/div[1]/input'
    peizhi1_3 = 'x=>//*[@id="ioper_08_1_a"]/div[2]/div[2]/div[2]/div/div[1]/input'
    peizhi1_4 = 'x=>//*[@id="ioper_08_1_a"]/div[2]/div[2]/div[3]/div/div/input'
    peizhi1_5 = 'x=>//*[@id="ioper_08_1_a"]/div[2]/div[2]/div[4]/div/div[1]/input'
    peizhi1_6 = 'x=>//*[@id="ioper_08_1_a"]/div[2]/div[2]/div[5]/div/input'
    peizhi1_7 = 'x=>//*[@id="ioper_08_1_a"]/div[2]/div[2]/div[6]/div/div[1]/input'

    def click_peizhi1_1(self):
        self.click(self.peizhi1_1)
        Logger().info('点击计算组件配置框1')

    def click_peizhi1_2(self):
        self.click(self.peizhi1_2)
        Logger().info('点击计算组件配置框1')

    def click_peizhi1_3(self):
        self.click(self.peizhi1_3)
        Logger().info('点击计算组件配置框1')
    ...
    def click_peizhi1_5(self):
        self.click(self.peizhi1_5)
        Logger().info('点击计算组件配置框1')

    def click_peizhi1_6(self):
        self.click(self.peizhi1_6)
        Logger().info('点击计算组件配置框1')
    ...
    def click_peizhi1_42(self):
        self.select2(self.peizhi1_4)
        Logger().info('选择关系2')

    def click_peizhi1_35(self):
        self.select5(self.peizhi1_3)
        Logger().info('选择关系2')
    ...
    zhiduan1_1 = 'x=>//*[@id="ioper_08_1_b"]/div/div[3]/div[2]/label[1]'
    zhiduan2_1 = 'x=>//*[@id="cnode_1025_2_b"]/div/div[3]/div[2]/label[1]'
    def click_zhiduan1_1(self):
        self.click(self.zhiduan1_1)
    def click_zhiduan2_1(self):
        self.click(self.zhiduan2_1)
